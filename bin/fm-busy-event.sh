...
#       Claude fm-send --key Escape path (fm-interrupt) and firstmate-applied
#       resets or corrections (fm-recovery; bin/fm-busy-lib.sh owns when that
#       source is legitimate) may pass --current-gen to bind to the

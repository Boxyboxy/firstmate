...
Grok and omp retain their tracked background-job notification protocols.
...
Claude depends on the Stop `asyncRewake` rewake, Grok and omp retain native background-completion notifications, and Codex retains bounded foreground checkpoints.

...
On every verified primary harness (`claude`, `codex`, `opencode`, `pi`, `grok`, and `omp`), "no turn ends blind" has a structural backstop beyond the pull-based `fm-guard.sh` banner.

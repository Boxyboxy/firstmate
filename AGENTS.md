...
config/omp-max-time  optional override of the default 3h omp `--max-time` runtime bound on omp workers this home launches; LOCAL, gitignored, and not inherited; see docs/configuration.md "Harness support"

...
Posture as of 2026-09-13, which changes what this step should cost.
The adapter branch's own contents were retired by captain ruling and the branch was restarted from
...
landed upstream; stop and report it rather than resolving a large merge, because the previous
divergence reached 52 files and 150 conflict hunks before it was retired.
Prefer landing anything reusable on `main` and keeping this branch thin.
